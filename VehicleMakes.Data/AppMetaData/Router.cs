namespace VehicleMakes.Data.AppMetaData
{
    public static class Router
    {
        ...
        public static class VehicleDetailRouting
        {
            public const string Prefix = Rule+"VehicleDetail";
        ...
        public static class MakeRouting
        {
            public const string Prefix = Rule + "Make";
            public const string List = Prefix + "/List";
            public const string GetByID = Prefix + SignleRoute;
            public const string Create = Prefix + "/Create";
            public const string Edit = Prefix + "/Edit";
        ...
        public static class MakeModelRouting
        {
            public const string Prefix = Rule + "Department";
            public const string GetByID = Prefix + "/Id";
            public const string GetDepartmentMakesCount = Prefix + "/Department-Makes-Count";
            public const string GetDepartmentMakesCountById = Prefix + "/Department-Makes-Count-ById/{id}";
