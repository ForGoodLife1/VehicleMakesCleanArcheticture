...
{
    public class EditVehicleDetailVailidatior : AbstractValidator<AddVehicleDetailCommand>
    {
        private readonly IVehicleDetailService _vehicleDetailService;
        private readonly IStringLocalizer<SharedResources> _localizer;

        public EditVehicleDetailVailidatior(IVehicleDetailService vehicleDetailService, IStringLocalizer<SharedResources> localizer)
        {
